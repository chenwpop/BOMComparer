"""This is the source code of BOM Comparer Tools for windows OS"""
import sys
import random
import time
import os.path
...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.simple = True
        self.folder_path = ""
        self.blue_box = "color: white; font: 10pt Arial; \
                          font-weight: bold; background-color: rgb(5,188,228);"
        self.green_box = "color: white; font: 10pt Arial; \
    ...
    def init_UI(self):
        ...
        backgroundWIN = QImage(resource_path("backgroundWIN.png"))
        backgroundWIN.scaled(QSize(1200,200))
        self.paletteMain = QPalette()
        self.paletteMain.setBrush(10, QBrush(backgroundWIN))
        ...
        inButton1.setFixedWidth(240)
        inButton1.move(344, 90)
        inButton1.setFlat(True)
        inButton1.setStyleSheet("background-color: rgb(10,170,200); \
                                 color: white; \
                                 font: 10pt Arial; \
                                 font-weight: bold;")
        ...
        inButton2.setFixedWidth(240)
        inButton2.move(632, 90)
        inButton2.setFlat(True)
        inButton2.setStyleSheet("background-color: rgb(22,167,150); \
                                 color: white; \
                                 font: 10pt Arial; \
                                 font-weight: bold;")
        ...
        cmp.move(880, 90)
        cmp.setFixedWidth(240)
        cmp.setFlat(True)
        cmp.setStyleSheet("background-color: rgb(24,140,72); \
                                 color: white; \
                                 font: 10pt Arial; \
                                 font-weight: bold;")
    ...
    def showHelp(self):
        ...
        help.setText("0. Read DECLARATION before use.\n"+ \
